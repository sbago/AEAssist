namespace AEAssist.Utilities.CombatMessages
{
    ...
    public interface ICombatMessageStrategy
    {
        ...
        //   "pack://application:,,,/AEAssist;component/Resources/Images/Monk/ArrowDownHighlighted.png"
        // Everything up "AEAssist;component/" needs to stay the same. After that, it's just the path from the project root and the filename.
