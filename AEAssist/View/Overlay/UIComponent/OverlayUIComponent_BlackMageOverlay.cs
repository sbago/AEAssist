...
namespace AEAssist.View.Overlay.UIComponent
{
    ...
    public class OverlayUIComponent_BlackMageOverlay : OverlayUIComponent
    {
        private OverlayControl _control;

        public OverlayUIComponent_BlackMageOverlay() : base(true)
        {
        }
        ...
        public override OverlayControl Control
        {
            get
            {
                ...
                var overlayUc = new BlackMageOverlayWindow();
